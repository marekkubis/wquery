...
class QueryReaderTestSuite extends WQueryTestSuite {
  ...
  @Test def testInLineComment() = queryReaderFor("123/*456*/7").readQuery.get should equal ("1237")
    
  @Test def testMultiLineComment() = queryReaderFor("123/*456\n789\n123\n*/99").readQuery.get should equal ("12399")

  @Test def testMultiLineCommentStart() = queryReaderFor("123/*456\n789\n123\n99").readQuery.get should equal ("123")

  @Test def testSemiColon() = queryReaderFor("123; 12").readQuery.get should equal ("123")
