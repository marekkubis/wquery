...
class MeasuresTestSuite extends WQueryTestSuite {
  ...
  @Test def testRootDistForCar() = result of "root_dist({car:1:n})" should equal ("12\n")

  @Test def testRootDistForBus() = result of "root_dist({'motor vehicle':1:n})" should equal ("11\n")
  ...
  @Test def testWupMeasure() = result of "wup_measure({bus:4:n}, {taxi:1:n})" should startWith ("0.9230769230769231")

  @Test def testWupMeasureOnHypernymyPath() = result of "wup_measure({bus:4:n}, {car:1:n})" should equal ("0.96\n")
