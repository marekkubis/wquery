...
class PlannerTests extends WQueryTestSuite {
  ...
  @Test def planSingleTransformation() {
    ...
    val forwardPlan = plans.find(_.toString == "ExtendOp(SynsetFetchOp(FetchOp(words,List((src,List(car))),List(src),true)),src&synset^hypernym^dst&synset,Forward,novars)").get
    val backwardPlan = plans.find(_.toString == "SelectOp(BindOp(ExtendOp(FringeOp(src&synset^hypernym^dst&synset,Right),src&synset^hypernym^dst&synset,Backward,novars),$__f@_),BinaryCondition(in,StepVariableRefOp($__f,Set(synset)),SynsetFetchOp(FetchOp(words,List((src,List(car))),List(src),true))))").get
  ...
  @Test def planInvertedTransformation() {
    ...
    val forwardPlan = plans.find(_.toString == "ExtendOp(SynsetFetchOp(FetchOp(words,List((src,List(cab))),List(src),true)),dst&synset^hypernym^src&synset,Forward,novars)").get
    val backwardPlan = plans.find(_.toString == "SelectOp(BindOp(ExtendOp(FringeOp(dst&synset^hypernym^src&synset,Right),dst&synset^hypernym^src&synset,Backward,novars),$__f@_),BinaryCondition(in,StepVariableRefOp($__f,Set(synset)),SynsetFetchOp(FetchOp(words,List((src,List(cab))),List(src),true))))").get
    val forwardResult = forwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
    val backwardResult = backwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
  ...
  @Test def planMultipleTransformations() {
    ...
    plan.toString should equal ("ExtendOp(ExtendOp(ExtendOp(FetchOp(synsets,List((src,List())),List(src),true),src&synset^hypernym^dst&synset,Forward,novars),src&synset^partial_holonym^dst&synset,Forward,novars),src&synset^hypernym^dst&synset,Forward,novars)")
  ...
  @Test def planTransformationsUnion() {
    ...
    val forwardPlan = plans.find(_.toString == "ExtendOp(SynsetFetchOp(FetchOp(words,List((src,List(car))),List(src),true)),RelationUnionPattern(List(src&synset^hypernym^dst&synset, src&synset^partial_holonym^dst&synset)),Forward,novars)").get
    val backwardPlan = plans.find(_.toString == "SelectOp(BindOp(ExtendOp(FringeOp(RelationUnionPattern(List(src&synset^hypernym^dst&synset, src&synset^partial_holonym^dst&synset)),Right),RelationUnionPattern(List(src&synset^hypernym^dst&synset, src&synset^partial_holonym^dst&synset)),Backward,novars),$__f@_),BinaryCondition(in,StepVariableRefOp($__f,Set(synset)),SynsetFetchOp(FetchOp(words,List((src,List(car))),List(src),true))))").get
  ...
  @Test def planTransformationsComposition() {
    ...
    plan.toString should equal ("ExtendOp(FetchOp(synsets,List((src,List())),List(src),true),RelationCompositionPattern(List(src&synset^hypernym^dst&synset, src&synset^partial_holonym^dst&synset, src&synset^hypernym^dst&synset)),Forward,novars)")
    emitted(result) should equal ("{ compartment:2:n } hypernym { room:1:n } partial_holonym { building:1:n edifice:1:n } hypernym { structure:1:n construction:4:n }\n{ person:2:n } hypernym { human body:1:n physical body:1:n material body:1:n soma:3:n build:2:n figure:2:n physique:2:n anatomy:2:n shape:3:n bod:1:n chassis:1:n frame:3:n form:5:n flesh:2:n } partial_holonym { person:1:n individual:1:n someone:1:n somebody:1:n mortal:1:n soul:2:n } hypernym { organism:1:n being:2:n }\n{ person:2:n } hypernym { human body:1:n physical body:1:n material body:1:n soma:3:n build:2:n figure:2:n physique:2:n anatomy:2:n shape:3:n bod:1:n chassis:1:n frame:3:n form:5:n flesh:2:n } partial_holonym { person:1:n individual:1:n someone:1:n somebody:1:n mortal:1:n soul:2:n } hypernym { causal agent:1:n cause:4:n causal agency:1:n }\n")
  }

  @Test def planOneOrMoreTransformations() {
    val plans = plansFor("{car:3:n}.hypernym+")
    val forwardPlan = plans.find(_.toString == "ExtendOp(SynsetFetchOp(FetchOp(senses,List((src,List(car:3:n))),List(src),true)),QuantifiedRelationPattern(src&synset^hypernym^dst&synset,{1,}),Forward,novars)").get
    val backwardPlan = plans.find(_.toString == "SelectOp(BindOp(ExtendOp(FringeOp(QuantifiedRelationPattern(src&synset^hypernym^dst&synset,{1,}),Right),QuantifiedRelationPattern(src&synset^hypernym^dst&synset,{1,}),Backward,novars),$__f@_),BinaryCondition(in,StepVariableRefOp($__f,Set(synset)),SynsetFetchOp(FetchOp(senses,List((src,List(car:3:n))),List(src),true))))").get
    val forwardResult = forwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
    val backwardResult = backwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
  ...
  @Test def planZeroOrMoreTransformations() {
    val plans = plansFor("{car:3:n}.hypernym*")
    val forwardPlan = plans.find(_.toString == "ExtendOp(SynsetFetchOp(FetchOp(senses,List((src,List(car:3:n))),List(src),true)),QuantifiedRelationPattern(src&synset^hypernym^dst&synset,{0,}),Forward,novars)").get
    val backwardPlan = plans.find(_.toString == "SelectOp(BindOp(ExtendOp(FringeOp(QuantifiedRelationPattern(src&synset^hypernym^dst&synset,{0,}),Right),QuantifiedRelationPattern(src&synset^hypernym^dst&synset,{0,}),Backward,novars),$__f@_),BinaryCondition(in,StepVariableRefOp($__f,Set(synset)),SynsetFetchOp(FetchOp(senses,List((src,List(car:3:n))),List(src),true))))").get
    val forwardResult = forwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
    val backwardResult = backwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
  ...
  @Test def planPathWithHighlySelectiveNodeFilter() {
    ...
    val forwardPlan = plans.find(_.toString == "SelectOp(BindOp(ExtendOp(FetchOp(synsets,List((src,List())),List(src),true),src&synset^hypernym^dst&synset,Forward,novars),$__#),BinaryCondition(in,StepVariableRefOp($__#,Set(synset)),SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true))))").get
    val backwardPlan = plans.find(_.toString == "BindOp(ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true)),src&synset^hypernym^dst&synset,Backward,novars),$__f@_)").get
    val forwardResult = forwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
    val backwardResult = backwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
  ...
  @Test def planPathWithHighlySelectiveContextFilter() {
    val plans = plansFor("{}.hypernym[# = {cab:3}]")
    val forwardPlan = plans.find(_.toString == "SelectOp(BindOp(ExtendOp(FetchOp(synsets,List((src,List())),List(src),true),src&synset^hypernym^dst&synset,Forward,novars),$__#),BinaryCondition(=,StepVariableRefOp($__#,Set(synset)),SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true))))").get
    val backwardPlan = plans.find(_.toString == "BindOp(ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true)),src&synset^hypernym^dst&synset,Backward,novars),$__f@_)").get
    val forwardResult = forwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
    val backwardResult = backwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
  ...
  @Test def planPathWithHighlySelectiveVariableFilter() {
    ...
    val forwardPlan = plans.find(_.toString == "SelectOp(ExtendOp(FetchOp(synsets,List((src,List())),List(src),true),src&synset^hypernym^dst&synset,Forward,$a),BinaryCondition(=,StepVariableRefOp($a,Set(synset)),SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true))))").get
    val backwardPlan = plans.find(_.toString == "BindOp(ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true)),src&synset^hypernym^dst&synset,Backward,$a),$__f@_)").get
    val forwardResult = forwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
    val backwardResult = backwardPlan.evaluate(wquery.wordNet, Bindings(), Context())
  ...
  @Test def choosePlanForPathWithHighlySelectiveNodeFilter() {
    ...
    plan.toString should equal ("BindOp(ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true)),src&synset^hypernym^dst&synset,Backward,novars),$__f@_)")
  ...
  @Test def choosePlanForPathWithHighlySelectiveGenerator() {
    ...
    plan.toString should equal ("ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true)),src&synset^hypernym^dst&synset,Forward,novars)")
  ...
  @Test def choosePlanForPathWithHighlySelectiveFilterAndGenerator() {
    ...
    plan.toString should equal ("SelectOp(BindOp(ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true)),src&synset^hypernym^dst&synset,Forward,novars),$__#),BinaryCondition(in,StepVariableRefOp($__#,Set(synset)),SynsetFetchOp(FetchOp(literal,List((dst,List(car)), (num,List(1))),List(src),true))))")
    emitted(result) should equal ("{ cab:3:n hack:5:n taxi:1:n taxicab:1:n } hypernym { car:1:n auto:1:n automobile:1:n machine:6:n motorcar:1:n }\n")
  }
  ...
  @Test def choosePlanByHighlySelectiveInnerFilter() {
    ...
    plan.toString should equal ("BindOp(ExtendOp(ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(cab)), (num,List(3))),List(src),true)),src&synset^hypernym^dst&synset,Forward,novars),src&synset^hypernym^dst&synset,Backward,novars),$__f@_)")
  ...
  @Test def choosePlanByHighlySelectiveOuterNodes() {
    ...
    plan.toString should equal ("NaturalJoinOp(ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(bus)), (num,List(4))),List(src),true)),src&synset^hypernym^dst&synset,Forward,$a),ExtendOp(SynsetFetchOp(FetchOp(literal,List((dst,List(ambulance)), (num,List(1))),List(src),true)),dst&synset^hypernym^src&synset,Backward,novars))")
